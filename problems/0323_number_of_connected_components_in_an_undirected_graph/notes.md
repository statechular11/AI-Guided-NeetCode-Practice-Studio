# Notes - 323. Number of Connected Components in an Undirected Graph
...
| `solution_dfs_components.py` | alternative graph traversal reference | Time: O(V + E); Space: O(V + E) |
