...
```bash
python -m tools.run_problem problems/0235_lowest_common_ancestor_of_a_binary_search_tree
python -m tools.run_problem problems/0235_lowest_common_ancestor_of_a_binary_search_tree --reference
```
