...
```bash
python -m tools.run_problem problems/0033_search_in_rotated_sorted_array
python -m tools.run_problem problems/0033_search_in_rotated_sorted_array --reference
```
